...
describe('generateFiles', () => {
  ...
  it('should fetch posts and generate markdown files', async () => {
    ...
    const expectedItemPath1 =
      mockPosts[0].link.split(rootPath)[1].replace(/\/$/, '') || 'index'
    ...
    const expectedItemPath2 = mockPosts[1].link
      .split(rootPath)[1]
      .replace(/\/$/, '')
  ...
  it('should handle nested files correctly', async () => {
    ...
    const expectedItemPath1 = nestedMockPosts[0].link
      .split(rootPath)[1]
      .replace(/\/$/, '')
    ...
    const expectedItemPath2 = nestedMockPosts[1].link
      .split(rootPath)[1]
      .replace(/\/$/, '')
    ...
    const expectedItemPath3 = nestedMockPosts[2].link
      .split(rootPath)[1]
      .replace(/\/$/, '')
